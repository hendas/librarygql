...
const getRandomIndex = (name) =>
  Math.floor(Math.random() * data[name].length) + 1;
...
const getRandomBook = () => getBookById(getRandomIndex('books'));
...
const getRandomAuthor = () => getAuthorById(getRandomIndex('authors'));
...
const getRandomUser = () => getUserById(getRandomIndex('users'));
